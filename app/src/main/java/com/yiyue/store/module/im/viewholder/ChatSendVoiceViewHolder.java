 ...
 */
public class ChatSendVoiceViewHolder extends BaseVoiceAdapter {
    private ImageView ic_user;
    private LinearLayout layout_send_voice;
    private TextView chat_tv_voicelen;
    private Context mContext;

    public ChatSendVoiceViewHolder(View view, Context context) {
        super(view);
        ic_user = (ImageView) itemView.findViewById(R.id.ic_user);
        layout_send_voice = (LinearLayout) itemView.findViewById(R.id.layout_recv_voice);
    ...
    public void setData(Object object) {
        ...
        if (object != null) {
            ...
            layout_send_voice.setOnClickListener(v -> {
                ToastUtils.shortToast("点击播放发送录音");
                onBubbleClick(model.getMessage());
            });
